...
export const handleWebhook = async (
  ...
  try {
    ...
    // Only process Quality Horticulture envelopes
    if (!envelopeSummary.emailSubject.includes("Quality Horticulture Account Application")) {
      console.log(`Ignored: Not a 'Quality Horticulture' form. Subject: ${envelopeSummary.emailSubject}`);
      res.status(200).send("Ignored non-Quality Horticulture form");
      return;
    }
